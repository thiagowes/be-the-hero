...
import { View, Image, Linking, Text, TouchableOpacity, ScrollView } from 'react-native';
...
export default function Incidents() {
  ...
  const message = `Olá ${incident.ong_name}, estou entrando em contato pois gostaria de ajudar no caso "${
    incident.title
